...
import { institutionUseCases } from "../../../infrastructure/factories/tutorial-module.factory";
...
export default function AdminInstitutions() {
  ...
  const createMutation = useMutation({
    mutationFn: (body: { name: string; description?: string }) => institutionUseCases.create(body),
    onSuccess: () => {
  ...
  const updateMutation = useMutation({
    mutationFn: (data: { id: string; body: { name?: string; description?: string } }) =>
      institutionUseCases.update(data.id, data.body),
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["admin-institutions"] });
      closeModal();
    },
  ...
  const deleteMutation = useMutation({
    mutationFn: (id: string) => institutionUseCases.delete(id),
