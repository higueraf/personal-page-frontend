...
import type { LessonContent } from "../../../domain/entities/video-course.entity";
...
export default function CourseViewer() {
  ...
  const metaQ = useQuery({
    ...
    queryFn: () => videoCourseUseCases.getPublicCourseMeta(courseSlug!),
    enabled: !!courseSlug,
  });
  ...
  const lessonQ = useQuery({
    ...
    queryFn: () => videoCourseUseCases.getPublicLesson(courseSlug!, activeSlug!),
