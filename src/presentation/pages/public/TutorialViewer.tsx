...
import { tutorialUseCases } from "../../../infrastructure/factories/tutorial-module.factory";
...
export default function TutorialViewer() {
  ...
  const metaQ = useQuery({
    ...
    queryFn: () => tutorialUseCases.getPublicBySlug(courseSlug!),
    enabled: !!courseSlug,
  });
  ...
  const pagesQ = useQuery({
    ...
    queryFn: () => tutorialUseCases.getPublicPages(courseSlug!),
  ...
  const contentQ = useQuery({
    ...
    queryFn: () => tutorialUseCases.getPublicPageContent(courseSlug!, activeSlug!),
