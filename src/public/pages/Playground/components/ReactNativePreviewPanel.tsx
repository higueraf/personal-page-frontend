  ...
  return (
    <div className="flex flex-col h-full bg-[#0d1117]">
      ...
      <div className="flex-1 overflow-auto flex items-center justify-center bg-[#0d1117] py-6">
        ...
        >
          {/* Volume up */}
          <div style={{ position:"absolute", left:-4, top:100, width:4, height:28, borderRadius:"2px 0 0 2px", background:"linear-gradient(to right,#333,#555)", boxShadow:"-1px 0 4px rgba(0,0,0,0.6)" }} />
          {/* Volume down */}
          <div style={{ position:"absolute", left:-4, top:138, width:4, height:28, borderRadius:"2px 0 0 2px", background:"linear-gradient(to right,#333,#555)", boxShadow:"-1px 0 4px rgba(0,0,0,0.6)" }} />
          {/* Power */}
          <div style={{ position:"absolute", right:-4, top:120, width:4, height:52, borderRadius:"0 2px 2px 0", background:"linear-gradient(to left,#333,#555)", boxShadow:"1px 0 4px rgba(0,0,0,0.6)" }} />
          ...
          <div style={{ width:"100%", height:"100%", borderRadius:36, overflow:"hidden", background:"#000", position:"relative" }}>
            ...
            >
              <span>9:41</span>
              {/* Dynamic Island */}
              <div style={{ position:"absolute", top:10, left:"50%", transform:"translateX(-50%)", width:100, height:28, background:"#000", borderRadius:20, border:"1.5px solid #2a2a2a", boxShadow:"0 2px 10px rgba(0,0,0,0.95)" }} />
              {/* Icons */}
            ...
            {/* Home indicator */}
            <div style={{ position:"absolute", bottom:6, left:"50%", transform:"translateX(-50%)", width:100, height:4, borderRadius:2, background:"rgba(255,255,255,0.35)", zIndex:10, pointerEvents:"none" }} />
          </div>
        </div>
      </div>
    </div>
